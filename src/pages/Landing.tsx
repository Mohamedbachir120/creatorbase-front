      ...
      <header className="sticky top-0 z-50 bg-neutral-900/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <a href="/" className="flex items-center gap-3" aria-label="Creatorbase Home">
              ...
              <h2 className="text-xl font-bold font-montserrat">Creatorbase</h2>
            </a>
  ...
  return (
    <footer className="bg-neutral-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center text-sm text-neutral-400">
        <p>© 2025 Creatorbase. Tous droits réservés.</p>
      </div>
    </footer>
  );
};
