...
const DashboardContent: FC = () => {
  ...
  const recommendedInfluencers: Influencer[] = isDataAvailable
    ? userProfile.visitedProfiles.map((profile) => ({
        ...
        category: `${profile.creator.region?.flag} ${profile.creator.region?.countryName}` || 'Monde',
        imageUrl: undefined,
    ...
    <>
      ...
      >
        ...
        <div className="flex space-x-3">
          {instagram && (
            <a href={instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" onClick={(e) => e.stopPropagation()}>
          ...
          {tiktok && (
            <a href={tiktok} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" onClick={(e) => e.stopPropagation()}>
              <div className="bg-gray-800 rounded-full p-2">
          ...
          {youtube && (
            <a href={youtube} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" onClick={(e) => e.stopPropagation()}>
              <div className="bg-gray-800 rounded-full p-2">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-300 animate-fadeIn" onClick={closeModal}>
          <div
          ...
          >
            <button onClick={closeModal} className="absolute top-3 right-3 text-gray-500 hover:text-white transition-colors z-10" aria-label="Close modal">
            ...
            <div className="p-6 md:p-8 text-center">
              ...
              {followers != null && followers != undefined && (
                <div className="flex items-center justify-center text-base text-gray-400 mt-1 mb-6">
